"""
Django settings for video_subtitle_search project.
...
if os.getenv("SECRET_KEY",None):
    ...
    raise ValueError("No SECRET KEY provide in environment.")
...
ROOT_URLCONF = 'video_subtitle_search.urls'
...
WSGI_APPLICATION = 'video_subtitle_search.wsgi.application'
